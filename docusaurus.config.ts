...
const config: Config = {
  ...
  plugins: [
    ...
    [
      ...
      {
        name: 'agent-docs',
        sourceBaseUrl: 'https://raw.githubusercontent.com/Aegis-AI-Organizations/Aegis-AI-Agent/main/docs/',
        outDir: 'docs/Agent',
    ...
    [
      ...
      {
        name: 'api-docs',
        sourceBaseUrl: 'https://raw.githubusercontent.com/Aegis-AI-Organizations/Aegis-AI-Api-Gateway/main/docs/',
        outDir: 'docs/API',
    ...
    [
      ...
      {
        name: 'brain-docs',
        sourceBaseUrl: 'https://raw.githubusercontent.com/Aegis-AI-Organizations/Aegis-AI-Brain/main/docs/',
        outDir: 'docs/Brain',
    ...
    [
      ...
      {
        name: 'dashboard-docs',
        sourceBaseUrl: 'https://raw.githubusercontent.com/Aegis-AI-Organizations/Aegis-AI-Dashboard/main/docs/',
    ...
    [
      ...
      {
        name: 'infra-docs',
        sourceBaseUrl: 'https://raw.githubusercontent.com/Aegis-AI-Organizations/Aegis-AI-Infra/main/docs/',
        outDir: 'docs/Infra',
    ...
    [
      'docusaurus-plugin-remote-content',
      {
        ...
        sourceBaseUrl: 'https://raw.githubusercontent.com/Aegis-AI-Organizations/Aegis-AI-Landing/main/docs/',
    ...
    [
      ...
      {
        name: 'proto-docs',
        sourceBaseUrl: 'https://raw.githubusercontent.com/Aegis-AI-Organizations/Aegis-AI-Proto/main/docs/',
        outDir: 'docs/Proto',
        documents: ['architecture.md', 'telemetry.md', 'quickstart.md'],
      },
    ],
    ...
    [
      'docusaurus-plugin-remote-content',
      {
        ...
        sourceBaseUrl: 'https://raw.githubusercontent.com/Aegis-AI-Organizations/Aegis-AI-Worker-Fixer/main/docs/',
    ...
    [
      'docusaurus-plugin-remote-content',
      {
        ...
        sourceBaseUrl: 'https://raw.githubusercontent.com/Aegis-AI-Organizations/Aegis-AI-Worker-Ingest/main/docs/',
    ...
    [
      'docusaurus-plugin-remote-content',
      {
        ...
        sourceBaseUrl: 'https://raw.githubusercontent.com/Aegis-AI-Organizations/Aegis-AI-Worker-Pentest/main/docs/',
